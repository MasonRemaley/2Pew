...
const MinimumAlignmentAllocator = engine.minimum_alignment_allocator.MinimumAlignmentAllocator;
const SymmetricMatrix = engine.symmetric_matrix.SymmetricMatrix;

const input_system = engine.input_system.init(enum {
    turn,
    thrust_forward,
    thrust_x,
    thrust_y,
